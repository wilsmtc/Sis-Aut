...
<div class="row">
    <div class="col-xs-12">
        ...
        <form class="form-horizontal" action="{{route('actualizar_personal', ['id' => $personal->id])}}" id="form-general" class="form-horizontal" method="POST" enctype="multipart/form-data">
            @csrf @method("put")
