...
<div class="page-header">
    <h1>
        ...
        <div class="box-tools pull-right">
            <a href="{{route('servicio')}}" class="btn btn-block btn-info btn-sm">
...
<div class="row">
    <div class="col-xs-12">
        ...
        <form class="form-horizontal" action="{{route('actualizar_servicio', ['id' => $servicio->id])}}" id="form-general" class="form-horizontal" method="POST" enctype="multipart/form-data">
            @csrf @method("put")
